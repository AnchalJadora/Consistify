...
import java.time.LocalDate;   //format 2024-01-15
...
public class Habit {
    ...
    private boolean isActive;           //true = active, false = soft delete
    ...
    @Override
    public String toString() { return name; }               //convert a object into readable strign format
}